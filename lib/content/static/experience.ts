...
export const experience: Experience[] = [
  {
    ...
    highlights: [
      "Collaborate cross-functionally with the marketing team to align technical work with business and communication goals.",
      "Translate complex technical concepts for non-technical stakeholders across a large distributed organization.",
      "Coordinate with security, compliance, and leadership to turn requirements into a shared project plan.",
    ],
    tech: [],
  },
  {
    ...
    is_current: true,
    summary_md:
      "Selected for a competitive national ML research cohort. Delivering a project end-to-end with a team of 4 peers and 2 senior researchers (Team Island Insight x KHLF).",
    highlights: [
      "Own a shared ML project end-to-end alongside a small research team.",
      "Report findings and progress to stakeholders and funders in clear, accessible language.",
      "Build consensus on project direction across diverse working styles.",
    ],
  ...
  },
  {
    ...
    highlights: [
      "De-escalate difficult customer situations with active listening and problem-solving.",
      "Help coworkers pick up new tools to better serve customers.",
    ],
    tech: [],
  },
  {
