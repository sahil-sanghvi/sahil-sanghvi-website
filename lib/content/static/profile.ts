...
export const profile: Profile = {
  ...
  bio_md:
    "Computer Science student at the University of Victoria (Software Systems specialization). I build complete software products — the app, the data pipeline behind it, and the automation that keeps it running without me. Right now I'm an AI intern at Protean eGov Technologies and an ML Research Fellow in RBC Borealis' Let's Solve It cohort. Before university I taught Python and C/C++ to 500+ students, and I lead UVic's UMANG Indian Students Association as Vice President.",
